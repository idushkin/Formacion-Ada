...
procedure Main is
   ...
   procedure MayorMenor(Primero:Integer; Segundo:Integer; Mayor : in out Integer; Menor: in out Integer) is
   begin
      if(Primero > Segundo)
      then Mayor:= Primero;
         Menor := Segundo;
...
begin
   ...
   --Invocando una funcion con parametros con nombre (named parameters)
   --  Primer_Valor := 16;
   --  Segundo_Valor := 39;
   --  Resultado := Sumar(N2 => Primer_Valor,
   --                     N1 => Segundo_Valor); --Los pongo al reves a proposito
   --  Put_Line("El Resultado de Sumar" & Primer_Valor'Image & " y" & Segundo_Valor'Image & " es" & Resultado'Image);
   ...
   --Esta SubPrograma tiene 4 parametros

   declare
      Supuesto_Mayor:Integer:=9;
      Supuesto_Menor:Integer:=19;
   begin
      MayorMenor(Supuesto_Menor,Supuesto_Mayor,Mayor => Supuesto_Mayor,Menor => Supuesto_Menor);
