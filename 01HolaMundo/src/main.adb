...
procedure Main is
   ...
   --N : Integer;
   Edad: Integer:= 0;  --OJO: A Ada le va a gustar mas que especifique el rango de edad
   Nombre : Unbounded_String; --Declaro un string Explicitamente
begin
   --Muestro un mensaje por pantalla
   --Ada.Text_IO.Put_Line("Hola Mundo Ada");
   --Ada.Text_IO.Put_Line("Bienvenidos a un nuevo lenguaje de programacion");

   --Una vez que agregamos el use no es necesario anteponer el nombre de la libreria
