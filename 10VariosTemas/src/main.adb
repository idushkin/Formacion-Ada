...
begin
   ...
   --     --type Nota_Descriptiva is ("Excelente", "Muy Bueno", "Bueno", "Regular", "Malo");
   --     --type Array_Numeros is array (Positive range <>) of Integer with Default_Component_Value => 10;
   ...
   --     Muchos_Numeros : Array_Numeros(1..15) := (1 =>2, 2|4=>3, 5=><>, others => 5); --Inicializando array con Aggregates
   ...
   declare
      ...
      Nacimiento : Fecha := (Dia => 20, Mes => 9, Año => 1980); --Inicializacion posicional
   begin
      Nacimiento.Dia := 20;
   end;
end Main;
