...
procedure Main is
   ...
   --  --type Cantidad is range 0..2**63-1; --Use 64 bits
   --  type Cantidad is range 0..2**127-1; --Use 128 bits
   --
   --
...
begin
   ...
   --  Peras := 2;
   --  Manzanas := 4;
   --  --Peras := Manzanas; --En cualquier lenguaje esta asignacion es  valida, pero en Ada no
   ...
   --     --  Base := 10.0;
   --     --  Altura := 30.0;
   --     --  --Superficie := Base * Altura; --Asignacion no compatible salvo que subtype area es Distancia
